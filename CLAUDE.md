...
powershell -ExecutionPolicy Bypass -File tools/Invoke-Gate.ps1     the whole gate: what CI runs, then the Excel half it cannot. -SkipExcel stops where CI stops, -Benchmarks adds the Release benchmarks
